        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Tid = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "25169fd8-c2e7-48c1-9171-97999076b27b", null, "Admin", "ADMIN" },
                    { "9447ca39-d094-4b92-b397-c5ae1e30f94e", null, "User", "USER" },
                    { "96ab759a-a528-4ab8-ab63-1a18aa78c951", null, "Moderator", "MODERATOR" }
                });
