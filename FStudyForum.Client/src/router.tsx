...
import SearchUserCommentPage from "./pages/user/search/comments";
import SearchTopicCommentPage from "./pages/topic/search/comments";
...
const SearchPostInTopic = Loadable(lazy(() => import("@/pages/topic/search/posts")));
